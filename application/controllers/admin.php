...
class admin extends CI_Controller
{
    ...
    {
        // Memuat model yang berisi logika untuk mendapatkan hasil ranking
        $this->load->model('perhitungan_model'); 

        $data['admin'] = $this->admin_model->admin_Active();
        $data['title'] = 'Penilaian Kinerja Guru - Laporan';
        $data['position'] = 'Laporan'; // Menandai menu 'Laporan' sebagai aktif
        ...
        $this->load->view('admin/laporan', $data); // Memuat view baru untuk laporan
    ...
    public function cetak_laporan()
    {
        ...
        $this->load->view('admin/cetak_laporan_pdf', $data);
        ...
        $this->dompdf->render();
        $this->dompdf->stream("laporan_kinerja_guru_" . $data['periode']['waktu'] . ".pdf", array('Attachment' => 0));
    }
    //Akun
